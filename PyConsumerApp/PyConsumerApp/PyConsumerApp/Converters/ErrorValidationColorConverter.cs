    ...
    public class ErrorValidationColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (PageVariantParameter == "0")
            {
                ...
                bindingContext.IsInvalidPhoneNumber =  !CheckValidNumber(bindingContext.PhoneNumber);
                //!isFocused &&
                if (isFocused)
                {
                ...
                return bindingContext.IsInvalidPhoneNumber ? Color.FromHex("#FF4A4A") : Color.Transparent;
            ...
            else
            {
                ...
                bindingContext.IsInvalidPhoneNumber = !isFocused1 && !CheckValidNumber(bindingContext.PhoneNumber);
                ...
                return bindingContext.IsInvalidPhoneNumber ? Color.FromHex("#FF4A4A") : Color.FromHex("#ced2d9");
        ...
        public static bool CheckValidNumber(string phoneNumber)
        {
